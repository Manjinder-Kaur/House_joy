...
<!--start-booking-->
	<div class="booking">
		<div class="container">
		<h1 style="text-align:center">Register Add Vendor</h1>
			...
			<form class="form-horizontal" action="getvendor.php" method="post" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
				  <button type="submit" name="sub" class="btn btn-danger">Register</button>
				  <a href="vendorlogin.php" button type="submit" name="sub" class="btn btn-danger">Vendor Login</button></a>
				</div>
			  </div>
</form>
		</div>
