	...
	<div class="content">
		<div class="container">
			<div class="content-top">
				<h3 style="text-align:center;">Our House Joy services</h3>
				<div class="col-md-4 grid">
				<a href="cat.php?x=1"><img class="img-responsive" style="height:260px"  src="images/a1.jpg" alt=""/>
					<div class="simply" >
						<h4>beauty</h4>
				...
				<div class="col-md-4 grid">
					<a href="cat.php?x=2"><img class="img-responsive" style="height:260px" src="images/a2.jpg" alt=""/>
					<div class="simply" >
						<h4>plumbing</h4>
				...
				<div class="col-md-4 grid">
					<a href="cat.php?x=3"><img class="img-responsive" style="height:260px" src="images/a3.jpg" alt=""/>
					<div class="simply" >
				...
				<div class="col-md-4 grid">
					<a href="cat.php?x=4"><img class="img-responsive" style="height:260px" src="images/a4.jpg" alt=""/>
					<div class="simply" >
						<h4>electrician</h4>
				...
				<div class="col-md-4 grid">
					<a href="cat.php?x=5"><img class="img-responsive" style="height:260px" src="images/a5.jpg" alt=""/>
					<div class="simply" >
				...
				<div class="col-md-4 grid">
					<a href="cat.php?x=6"><img class="img-responsive" style="height:260px" src="images/a6.jpg" alt=""/>
					<div class="simply" >
						<h4>carpentry</h4>
				...
				<div class="col-md-4 grid">
				<a href="cat.php?x=7"><img class="img-responsive" style="height:260px" src="images/a7.jpg" alt=""/>
					<div class="simply" >
						<h4>air condition</h4>
				...
				<div class="col-md-4 grid">
						<a href="cat.php?x=8"><img class="img-responsive" style="height:260px" src="images/a8.jpg" alt=""/>
					<div class="simply" >
						<h4>car and bike</h4>
				...
				<div class="col-md-4 grid">
					<a href="cat.php?x=9"><img class="img-responsive" style="height:260px" src="images/a9.jpg" alt=""/>
					<div class="simply" >
