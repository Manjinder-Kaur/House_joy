	...
	?>
		...
		<div class="wthree-main-content w3layouts-contact">
			...
			<div class="agileits contact">
				<div class="container">
					<h2 class="agile-inner-title" style="text-align:center">Pending Vendor Status</h2>						
					<!-- about-top -->
					<div class="gallery">
			...
			<form class="form-horizontal" method="get" action="getvapp.php">			
				<table class="table table-bordered table-responsive">
                    <thead>
						...
						<?php
							include "config.php";
							$q="SELECT `v_id`, `v_name`, `v_email`, `v_contact`, `v_professional`, `v_experience`, `v_address`, `v_pic`, `v_status` FROM `vendor` WHERE v_status='0'";
